...
public class Enemy_2 extends Sprite {
    ...
    public Enemy_2(World world, PlayScreen screen) {
        this.world = world;
    ...
    public void enemyMovement() {
        if (b2body.getLinearVelocity().x == 0 || b2body.getPosition().x > 485)
            b2body.setLinearVelocity(-30, 0);
        if (b2body.getPosition().x < 460)
            b2body.setLinearVelocity(30, 0);
    }
}